...
export interface Prisma {
  ...
  updateLuiism: (args: {
    data: LuiismUpdateInput;
    where: LuiismWhereUniqueInput;
  }) => LuiismPromise;
  updateManyLuiisms: (args: {
    data: LuiismUpdateManyMutationInput;
    where?: LuiismWhereInput;
  }) => BatchPayloadPromise;
  upsertLuiism: (args: {
    where: LuiismWhereUniqueInput;
...
export interface UserPromise extends Promise<User>, Fragmentable {
  id: () => Promise<ID_Output>;
  name: () => Promise<String>;
  submissions: <T = FragmentableArray<Luiism>>(args?: {
    where?: LuiismWhereInput;
    orderBy?: LuiismOrderByInput;
    skip?: Int;
    after?: String;
  ...
  favourites: <T = FragmentableArray<Luiism>>(args?: {
    where?: LuiismWhereInput;
    orderBy?: LuiismOrderByInput;
    skip?: Int;
    after?: String;
...
export interface UserSubscription
  ...
  id: () => Promise<AsyncIterator<ID_Output>>;
  name: () => Promise<AsyncIterator<String>>;
  submissions: <T = Promise<AsyncIterator<LuiismSubscription>>>(args?: {
    where?: LuiismWhereInput;
    orderBy?: LuiismOrderByInput;
    skip?: Int;
    after?: String;
  ...
  favourites: <T = Promise<AsyncIterator<LuiismSubscription>>>(args?: {
    where?: LuiismWhereInput;
    orderBy?: LuiismOrderByInput;
    skip?: Int;
    after?: String;
...
export interface LuiismPromise extends Promise<Luiism>, Fragmentable {
  ...
  favouritedBy: <T = FragmentableArray<User>>(args?: {
    where?: UserWhereInput;
    orderBy?: UserOrderByInput;
    skip?: Int;
    after?: String;
...
export interface LuiismSubscription
  ...
  definition: () => Promise<AsyncIterator<String>>;
  submittedBy: <T = UserSubscription>() => T;
  favouritedBy: <T = Promise<AsyncIterator<UserSubscription>>>(args?: {
    where?: UserWhereInput;
    orderBy?: UserOrderByInput;
    skip?: Int;
    after?: String;
...
export const Prisma = makePrismaClientClass<ClientConstructor<Prisma>>({
  typeDefs,
  models,
  endpoint: `https://luiisms-prisma.herokuapp.com/luiisms/dev`
});
